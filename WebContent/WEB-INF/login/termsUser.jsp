...
<section>
	<h2>제작자 : ${author }</h2>
		<article>
		<h2 class="title" style="text-align: center">이용약관 동의</h2>
			<textarea rows="40" cols="100" readonly style="display:block ; margin: 0 auto;">
	제 1 장 총 칙
	
제 1 조 (목적)
이 약관은 본 사이트(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
(시행일) 이 약관은 2023년 05월부터 시행합니다.
	</textarea>
	
				<div style="text-align: center">
					<input type="checkbox" id="chk1" name="chk1"><label for="chk1">이용약관 동의</label>
				</div>
			</article>
				<hr>
                <h2 style="text-align: center ; padding-top:50px"> 개인정보 수집 동의</h2>
               
                <textarea rows="30" cols="100" readonly style="display:block ; margin: 0 auto;">
...
- 수집하는 개인정보 항목 (이력서 양식 내용 일체) : 성명, 주민등록번호, 전화번호, 주소, 이메일, 가족관계, 학력사항, 경력사항, 자격사항 등과 그 外 이력서 기재 내용 일체
...
- 귀하의 개인정보를 다음과 같이 보관하며, 수집, 이용 및 제공목적이 달성된 경우 [개인정보 보호법] 제21조에 따라 처리합니다.   
				...
				<div style="text-align: center">
				<input type="checkbox" id="chk2" name="chk2" ><label for="chk2"  >개인정보 수집 동의 </label>
				</div>
				<hr>
				<div style="text-align:center">
				<!-- <input type="button" name="chk3" id="chk3" onclick="protocol()" value="전체 약관에 동의"> -->
				<label for="chk3" onclick="protocol()" ><strong>전체 약관에 동의</strong></label>
				</div>
			...
			<div class="blank" style="padding-bottom:100px">
			</div>
			<script>
				...
				btn.addEventListener("click",function(){
					if(chk1.checked && chk2.checked){
						location.href = "${path1 }/GoInsertUser.do";
					}else{
						alert("체크안한게 있습니다.");
						return;
					}

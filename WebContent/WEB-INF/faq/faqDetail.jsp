...
<div class="wrap_bt">
	...
	<h1>공지사항</h1>
	<form action="${path1 }/UpdateFaq.do?fno=${faq.fno }" method="post" >
		<table>
		<tr>
			<th>카테고리</th>
			<td>
		...
		<tr>	
			...
			<td><input type="text" name="title" id="title" value="${faq.title }" required></td>
		</tr>
		<tr>
			<th><label for="content">내용</label></th>
			<td><textarea rows="10" name="content" id="content" required>${faq.content }</textarea></td>
		</tr>
		<tr>
